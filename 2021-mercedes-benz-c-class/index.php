...
<body>
    ...
    <section id="bidding-page">
        <div class="vehicle-details">
            <img src="./mercedes.jpg" alt="2015 Ford Mustang">
            <h1>2021 Mercedes-Benz C-Class</h1>
            <p>Current Bid: $40,000</p>
            <form id="bid-form" method="POST" action="place_bid.php">
                <input type="hidden" name="email" value="<?php echo $email; ?>">
                <input type="hidden" name="vehicle_name" value="2021 Mercedes-Benz C-Class">
